        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, model.fit(xs, ys, { epochs: epochs, batchSize: batchSize, verbose: 1 })];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    xs = tf.randomNormal([numSamples, 8]);
                    ys = tf.randomNormal([numSamples, 1]);
                    return [4, model.fit(xs, ys, { epochs: epochs, batchSize: batchSize, validationSplit: validationSplit, verbose: 2 })];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    xs = tf.randomNormal([numSamples, 8]);
                    ys = tf.randomNormal([numSamples, 1]);
                    return [4, model.fit(xs, ys, { epochs: epochs, batchSize: batchSize, validationSplit: validationSplit, verbose: 0 })];
                case 1:
                    _a.sent();
